...
from .models import FileUpload, Sources, Source_file, Clg, Department, ClassModule, Notes
...
# Define the CustomAdmin class
class CustomAdmin(admin.ModelAdmin):
    actions = [export_to_excel]

# Register models only if they are not already registered
models = [FileUpload, Sources, Source_file, Clg, Department, ClassModule, Notes]
